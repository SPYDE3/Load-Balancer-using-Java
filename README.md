...
Running the Project
Clone the repository: git clone https://github.com/Hiranmaya2004/MultithreadedWebServer.git
Navigate to the project directory and compile:
Run the server:
Access the server via a web browser at http://localhost:8080 (or configured port).
Project Structure
